...
const entrar = async (e) =>{
 ...
 ;
    ...
    return (
        ...
        <div className="w-full  flex justify-center items-center bg-[url('/public/img/fundo_login.jpg')] bg-cover bg-center h-[900px] font-boa">
            ...
            flex flex-col justify-center items-center w-[400px] rounded-t-3xl gap-5 p-6 -mt-12 h-[700px] md:overflow-hidden
            "> 
                <div className="md:w-[50%] md:h-full   md:relative md:top-1 md:bg-black/90 md:flex md:justify-center md:items-center md:-ml-16 ">
                ...
                <div id="FORMULARIO" className="flex  flex-col justify-center items-center gap-2  md:h-[450px]">
                    ...
                    <form onSubmit={entrar} className="flex flex-col tracking-[5px]">
                        <label htmlFor="" className="m-2">Matricula</label>
                        <input type="number" disabled={is} onChange={(e) => {setmatricula(e.target.value)}} onClick={(e) => e.target.classList.remove('border-red-800')} name="matricula"className="border-solid border  bg-transparent    h-10 w-[250px] rounded-2xl text-center placeholder-white" placeholder="Digite Matricula" max="999999"/>
                        <label htmlFor="" className="m-2 ">Senha :</label>
                        <input type="password" name="senha" onChange={(e) => {setsenha(e.target.value)}} onClick={(e) => e.target.classList.remove('border-red-800')} className="border-solid border  bg-transparent  h-10 w-[250px] rounded-2xl  text-center placeholder-white" placeholder="Digite Senha"/>
                        {spin ?
                       <div className="p-5  gap-4 absolute mt-[160px] flex  justify-center items-center mb-24 h-[60px]">
                    ...
                    {
                        spin ? "" :
                        <Link to="/EsqueceuSenha" className="p-6 underline">Esqueceu a senha</Link>
                    }
                </div>
            </div>
