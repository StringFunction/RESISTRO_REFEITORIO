...
function MOSTRA(){
 const resultado = dados.find(dado => dado.matricula == matricula)
 setS(resultado)
    ...
    return (
        ...
        <div className="flex  flex-col gap-9 items-center justify-center bg-gray-300 h-96">
            ...
            <h1 className="text-5xl">REGISTRA DE FUNCIONARIO</h1>   
            <div className="flex flex-col gap-9"> 
                ...
                <h1><h1>{resultado ? "Matrícula encontrada" : "Matrícula não encontrada"}</h1></h1>
